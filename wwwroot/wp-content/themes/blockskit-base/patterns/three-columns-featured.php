...
<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--xx-large);margin-bottom:var(--wp--preset--spacing--xx-large)"><!-- wp:columns {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}},"className":"animated animated-fadeInUp"} -->
<div class="wp-block-columns animated animated-fadeInUp" style="margin-bottom:var(--wp--preset--spacing--medium)"><!-- wp:column {"style":{"spacing":{"padding":{"right":"var:preset|spacing|xx-small","left":"var:preset|spacing|xx-small"}}}} -->
<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--xx-small);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:group {"style":{"border":{"radius":"5px"},"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large","right":"var:preset|spacing|large"}}},"className":"is-style-bk-box-shadow","layout":{"type":"constrained"}} -->
...
<!-- wp:column {"style":{"spacing":{"padding":{"right":"var:preset|spacing|xx-small","left":"var:preset|spacing|xx-small"}}}} -->
<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--xx-small);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:group {"style":{"border":{"radius":"5px"},"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large","right":"var:preset|spacing|large"}}},"className":"is-style-bk-box-shadow","layout":{"type":"constrained"}} -->
...
<div class="wp-block-columns animated animated-fadeInUp"><!-- wp:column {"style":{"spacing":{"padding":{"right":"var:preset|spacing|xx-small","left":"var:preset|spacing|xx-small"}}}} -->
<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--xx-small);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:group {"style":{"border":{"radius":"5px"},"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large","right":"var:preset|spacing|large"}}},"className":"is-style-bk-box-shadow","layout":{"type":"constrained"}} -->
<div class="wp-block-group is-style-bk-box-shadow" style="border-radius:5px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:image {"align":"center","id":323,"scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|primary"}}} -->
...
<!-- wp:column {"style":{"spacing":{"padding":{"right":"var:preset|spacing|xx-small","left":"var:preset|spacing|xx-small"}}}} -->
<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--xx-small);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:group {"style":{"border":{"radius":"5px"},"spacing":{"padding":{"top":"var:preset|spacing|large","bottom":"var:preset|spacing|large","left":"var:preset|spacing|large","right":"var:preset|spacing|large"}}},"className":"is-style-bk-box-shadow","layout":{"type":"constrained"}} -->
<div class="wp-block-group is-style-bk-box-shadow" style="border-radius:5px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:image {"align":"center","id":322,"width":45,"height":45,"scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"color":{"duotone":"var:preset|duotone|primary"}}} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo esc_url($blockskit_base_images[5]); ?>" alt="" class="wp-image-322" style="object-fit:cover;width:45px;height:45px" width="45" height="45"/></figure>
<!-- /wp:image -->
